...
def parse():
    ...
    parser.add_argument('--height', default=256, type=int, help="HSI height")
    parser.add_argument('--width', default=256, type=int, help="HSI width")
    parser.add_argument('--nbands', default=31, type=int, help="HSI bands")
    ...
    parser.add_argument('--mu', default=3e1, type=float, help="TVDS regularization parameter")
    parser.add_argument('--rho', default=3e1, type=float, help="ADMM penalty parameter")
    ...
    parser.add_argument('--rank', default=None, type=int, help="The rank of subspace (3 for rgb, 1 for pan), if use_net_init, it can be higher.")
